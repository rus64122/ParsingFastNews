...
from config import token, user_id2
...
async def get_fresh_news(message: types.Message):
    ...
    if len(fresh_news) >= 1:
        ...
        await message.answer("Cвежих новостей нет...")
...
async def news_every_minute():
    while True:
        ...
        # else:
        #     await bot.send_message(user_id2, "Свежих новостей нет...", disable_notification=True)
